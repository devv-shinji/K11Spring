...
<body>
	<h2>스프링 MVC 시작하기</h2>
	<!-- 
		Spring MVC에서는 이미지와 같은 리소스를 사용하기 위해  별도의 resources폴더를 제공한다. 
	...
	<!-- 폼 데이터 전송 전 프론트단에서 JS로 1차 검증을 하며, 아래의 방법으로 서버단에서 2차 검증을 진행한다. -->
...
6. View로 전달할 정보를 model객체에 저장한 후 호출
 ...
 -->
   ...
   <li>
	...
	- 이와 같이 양쪽 모두 만족되어야 하나의 프로세스를 완료처리 할 수 있도록 해주는 기법을
	트랜잭션 이라고 한다.
